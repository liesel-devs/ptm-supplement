...
@click.option("--igprior", type=str, required=True, default="1,0.001")
def run_one(
    data_seed,
    data_type,
    ntest,
    ...
    newdata = {}
    newdata["response"] = test["y"].to_numpy()[:500]
    for i in range(4):
        smooth = smooths[i]
        newdata[f"B(x{i})"] = smooth(test[f"x{i}"].to_numpy()[:500])  # type: ignore
    ...
    dist_summary["ig_a"] = ig_a
    dist_summary["ig_b"] = ig_b
    ...
    covariates_summary["ig_a"] = ig_a
    covariates_summary["ig_b"] = ig_b
    ...
    diagnostics["ig_a"] = ig_a
    diagnostics["ig_b"] = ig_b

    # ..............................................................................
    # ---- Write results to disk ----
    # ..............................................................................

    identifier = f"{jobrow}-{model}-{data_type}-{data_seed:03d}-n{ntrain}.csv"
