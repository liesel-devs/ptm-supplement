...
# ..............................................................................
if ALL_DATA:  # only for full dataset
    newdata = {"age": data["age"].to_numpy()}
    dist = mod.init_dist(samples, newdata=newdata)
    z_samples = dist.transformation_and_logdet(data["bmi"].to_numpy())[0]
    z_summary = (
...
if ALL_DATA:  # only for full dataset
    ...
    r_grid = jnp.linspace(-5.0, 7.0, 250)
...
if ALL_DATA:
    ...
    summaries["z_summary"] = z_summary
    summaries["prob_summary"] = prob_summary
